    ...
    \IteratorAggregate
{
     ...
     */
    public function overlaps(IntervalInterface $interval)
    {
        $startDate = $interval->getStart();
        $endDate   = $interval->getEnd();

        return $this->checkOverlaping($startDate, $endDate);
    }
     ...
     */
    private function checkOverlaping(\DateTime $start, \DateTime $end)
    {
